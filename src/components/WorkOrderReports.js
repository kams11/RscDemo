  ...
  return (
    <section className='userReports' style={{height:"100vh",width:"100%"}}>
        ...
        <div className='report1'> <a style={{textDecoration:"none",color:"white"}} href="/UserReporting">
                 ...
                 <p style={{paddingLeft:"40px"}} >Transform Order Reports</p></a>
          </div>

          <div className="report2"> <a style={{textDecoration:"none",color:"white"}} href="/WorkOrderReports">
                  <div className="woReports" style={{height:"60px",width:"60px",border:"2px solid rgba(247, 63, 8, 0.712)",borderRadius:"30px",marginLeft:"80px"}}><GiNotebook style={{height:"55px"}}/></div> <br /> <p style={{textDecoration:"underline",paddingLeft:"40px",fontWeight:"600"}} >Work Order Reports</p></a>
            </div>  
